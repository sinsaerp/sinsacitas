        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput2">CODIGO address</label>
                        <input type="text" class="form-control" id="exampleFormControlInput2" wire:model="codigo" placeholder="CODIGO">
